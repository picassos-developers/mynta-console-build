...
public class GetStartedAdapter extends PagerAdapter {
    ...
    public GetStartedAdapter(Context context, List<Guide> listScreen) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        @SuppressLint("InflateParams") View layoutScreen = inflater.inflate(R.layout.item_guide_listitem, null);

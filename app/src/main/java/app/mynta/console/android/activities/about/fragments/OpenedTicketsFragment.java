...
public class OpenedTicketsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_opened_tickets, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // open ticket
        CardView openTicket = view.findViewById(R.id.open_ticket);
        openTicket.setOnClickListener(v -> startActivity(new Intent(requireContext(), SubmitTicketActivity.class)));
    ...
    private void requestTickets() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, API.API_URL + API.REQUEST_OPENED_TICKETS,
                response -> {
                    try {
                        ...
                        if (array.length() == 0) {
                            ...
                            view.findViewById(R.id.no_items).setOnClickListener(v -> startActivity(new Intent(requireContext(), SubmitTicketActivity.class)));
                        } else {

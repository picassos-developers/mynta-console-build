package app.mynta.console.android.libraries.showcaseview;
...
import app.mynta.console.android.libraries.showcaseview.config.PointerType;
import app.mynta.console.android.libraries.showcaseview.listener.GuideListener;
...
public class GuideView extends FrameLayout {
    ...
    private static final int RADIUS_SIZE_TARGET_RECT = 20;
    ...
    private GuideView(Context context, View view) {
        ...
        mMessageView.setColor(Color.parseColor("#121212"));
